...
data class Book(
    ...
    var addedDate:Long=System.currentTimeMillis(), var lastOpened:Long=0L, var sourceFilename:String="", var extractedRoot:String=""
)
class BookStore(context:Context) {
    ...
    private fun to(b:Book)=JSONObject().apply{put("id",b.id);put("title",b.title);put("author",b.author);put("cover",b.coverPath);put("description",b.description);put("publisher",b.publisher);put("language",b.language);put("year",b.year);put("identifier",b.identifier);put("progress",b.progress);put("spine",b.spineIndex);put("page",b.pageIndex);put("pageCount",b.pageCount);put("favorite",b.isFavorite);put("reading",b.isCurrentlyReading);put("added",b.addedDate);put("last",b.lastOpened);put("source",b.sourceFilename);put("root",b.extractedRoot)}
    private fun from(o:JSONObject)=Book(o.getString("id"),o.optString("title","Untitled"),o.optString("author","Unknown Author"),o.optString("cover",null),o.optString("description",null),o.optString("publisher",null),o.optString("language",null),o.optInt("year",0).takeIf{it!=0},o.optString("identifier",null),o.optDouble("progress",0.0).toFloat(),o.optInt("spine",0),o.optInt("page",0),o.optInt("pageCount",1),o.optBoolean("favorite"),o.optBoolean("reading"),o.optLong("added",System.currentTimeMillis()),o.optLong("last",0),o.optString("source",""),o.optString("root",""))
}
