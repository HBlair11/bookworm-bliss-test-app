...
import com.bookwormbliss.app.ReaderActivity
...
class ReaderTtsService : Service() {
    ...
    companion object {
        ...
        const val ACTION_PAUSE_RESUME = "com.bookwormbliss.app.tts.PAUSE_RESUME"
        const val ACTION_STOP = "com.bookwormbliss.app.tts.STOP"
