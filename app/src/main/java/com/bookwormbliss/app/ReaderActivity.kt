...
import com.bookwormbliss.app.core.reader.ReaderCssBuilder
import com.bookwormbliss.app.core.reader.ReaderPaginationScriptBuilder
...
import com.bookwormbliss.app.data.DictionaryHistoryEntity
import com.bookwormbliss.app.data.PrefsManager
import com.bookwormbliss.app.data.TtsSettingsEntity
import com.bookwormbliss.app.epub.ReaderSelectionBridge
import com.bookwormbliss.app.epub.ReaderSelectionLocator
...
import com.bookwormbliss.app.epub.EpubSearchEngine
import com.bookwormbliss.app.epub.ReaderPageMapping
import com.bookwormbliss.app.epub.ReaderTtsController
import com.bookwormbliss.app.tts.ReaderTtsService
import com.bookwormbliss.app.ui.BookmarkAdapter
import com.bookwormbliss.app.ui.HighlightListAdapter
import com.bookwormbliss.app.ui.ReaderSettingsActivity
import com.bookwormbliss.app.ui.ReaderTheme
import com.bookwormbliss.app.ui.SearchResultAdapter
...
class ReaderActivity : AppCompatActivity() {
    ...
    private var dictionaryLookup: com.bookwormbliss.app.epub.DictionaryLookup? = null
     ...
     *  them. */
    private fun highlightSpokenWord(segment: com.bookwormbliss.app.epub.ReaderTtsSegment, start: Int, end: Int) {
    ...
    private fun recordReadingSession(now: Long) {
        ...
        if (seconds >= 10 && bookId >= 0L) {
            val session = com.bookwormbliss.app.data.ReadingSessionEntity(
    ...
    private fun showDefinition(selection: ReaderSelectionLocator?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val lookup = dictionaryLookup?.takeIf { it.matchesLanguage(lang) }
                ?: com.bookwormbliss.app.epub.DictionaryLookup(applicationContext, lang ?: com.bookwormbliss.app.epub.DictionaryLookup.DEFAULT_LANGUAGE)
    ...
    private fun showDefinitionCard(
        raw: String,
        result: com.bookwormbliss.app.epub.DictionaryLookup.Result,
    ...
    private fun saveHighlight(selection: ReaderSelectionLocator, color: Int) {
        val href = selection.spineHref
        val highlight = com.bookwormbliss.app.data.HighlightEntity(
            bookId = bookId,
            spineHref = href,
            text = selection.text,
            color = color,
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            val id = com.bookwormbliss.app.data.BookRepository(applicationContext).addHighlight(highlight)
            withContext(Dispatchers.Main) {
     ...
     */
    private fun goToHighlight(highlight: com.bookwormbliss.app.data.HighlightEntity) {
        clearReaderSelection()
        val book = epub ?: return
    ...
    private fun injectHighlightsForChapter() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            val highlights = com.bookwormbliss.app.data.BookRepository(applicationContext)
    ...
    private fun showHighlightNoteSheet(highlightId: Long) {
        lifecycleScope.launch(Dispatchers.IO) {
            val repo = com.bookwormbliss.app.data.BookRepository(applicationContext)
