...
import com.bookwormbliss.app.data.CollectionEntity
import com.bookwormbliss.app.data.GroupedRow
import com.bookwormbliss.app.databinding.ItemAuthorSeriesBinding
...
class RowAdapter(
    ...
    inner class RowVH(private val b: ItemAuthorSeriesBinding) : RecyclerView.ViewHolder(b.root) {
        fun bind(vd: RowVd) {
            ...
            b.subtitle.text =
                "${vd.count} " + if (vd.count == 1) itemView.context.getString(com.bookwormbliss.app.R.string.progress_book) else itemView.context.getString(
                    com.bookwormbliss.app.R.string.progress_books
                )
