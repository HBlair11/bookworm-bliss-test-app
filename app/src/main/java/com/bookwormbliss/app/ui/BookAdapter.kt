...
import com.bookwormbliss.app.databinding.ItemBookGridBinding
import com.bookwormbliss.app.databinding.ItemBookListBinding
...
class BookAdapter(
    ...
    inner class BookGridHolder(private val b: ItemBookGridBinding) : RecyclerView.ViewHolder(b.root) {
        ...
        fun bind(book: BookEntity) {
            ...
            b.author.text =
                book.author.ifBlank {
                    itemView.context.getString(com.bookwormbliss.app.R.string.unknown_author)
                }
    ...
    inner class BookListHolder(private val b: ItemBookListBinding) : RecyclerView.ViewHolder(b.root) {
        ...
        fun bind(book: BookEntity) {
            b.title.text = book.title
            b.author.text =
                book.author.ifBlank { itemView.context.getString(com.bookwormbliss.app.R.string.unknown_author) }
    ...
    private fun loadCover(book: BookEntity, view: android.widget.ImageView) {
        ...
        if (coverPath != null) {
            Glide.with(view).load(java.io.File(coverPath))
                .centerCrop()
                .placeholder(com.bookwormbliss.app.R.drawable.cover_frame)
                .into(view)
        } else {
            Glide.with(view).clear(view)
            view.setImageResource(com.bookwormbliss.app.R.drawable.cover_frame)
        }
    }
