...
import com.bookwormbliss.app.databinding.ActivityBookDetailsBinding
...
class BookDetailsActivity : AppCompatActivity() {
    ...
    private lateinit var keepScreenOnController:
            com.bookwormbliss.app.util.KeepScreenOnController
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        keepScreenOnController =
            com.bookwormbliss.app.util.KeepScreenOnController(
                this,
                com.bookwormbliss.app.data.PrefsManager(applicationContext)
            )
    ...
    private fun bind(book: BookEntity) {
        ...
        binding.btnReadingNook.setOnClickListener {
            startActivity(
                Intent(
                    this,
                    ReadingNookActivity::class.java
                ).putExtra(
                    ReadingNookActivity.EXTRA_BOOK_ID,
                    book.id
                )
            )
        }
