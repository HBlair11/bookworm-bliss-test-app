...
import com.bookwormbliss.app.data.SourceFingerprint
import java.io.File
            ...
            try {
                ...
                if (!copied) {
                    results += MetadataRefreshItem(
                        ...
                        context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_read_failed)
                    )
                    continue
                }
                ...
                if (parsed == null) {
                    results += MetadataRefreshItem(
                        MetadataRefreshStatus.FAILED, null, source.name, "",
                        context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_parse_failed)
                    )
                    continue
                }
                ...
                if (existing == null) {
                    results += MetadataRefreshItem(
                        ...
                        context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_no_safe_match)
                    )
                    continue
                }
                ...
                if (existing.metadataEdited) {
                    ...
                    results += MetadataRefreshItem(
                        ...
                        source.name,
                        existing.author,
                        context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_user_edited),
                    )
                    continue
                }
                ...
                val detail = when {
                    changed && contentDiffers -> context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_updated_content_differs)
                    changed -> context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_updated)
                    contentDiffers -> context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_unchanged_content_differs)
                    else -> context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_unchanged)
                }
                ...
                results += MetadataRefreshItem(
                    MetadataRefreshStatus.FAILED, null, source.name, "",
                    context.getString(com.bookwormbliss.app.R.string.metadata_refresh_detail_failed)
                )
            } finally {
                tempFile?.delete()
            }
