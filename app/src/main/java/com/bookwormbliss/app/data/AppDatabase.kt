...
@Database(
    entities = [BookEntity::class, BookmarkEntity::class, HighlightEntity::class, CollectionEntity::class, BookCollectionRef::class, ReadingSessionEntity::class, DictionaryHistoryEntity::class, TtsSettingsEntity::class, SearchHistoryEntity::class],
    version = 17,
    exportSchema = false,
)
