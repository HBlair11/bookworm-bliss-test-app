...
val appId = providers.gradleProperty("BOOKWORMBLISS_APPLICATION_ID").get()
val appVersionCode = providers.gradleProperty("BOOKWORMBLISS_VERSION_CODE").get().toInt()
val appVersionName = providers.gradleProperty("BOOKWORMBLISS_VERSION_NAME").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "APP_NAME", "\"The Bookworm Bliss\"")
    }
    ...
    // The user installs the APK named "bookworm-bliss.apk".
